...
public:
    ...
    void PerformScanning(int data_layer, int marker_layer);
    void ExtractAllMarkedAreasAsJPG(int data_layer, int marker_layer);
    void ExtractMarkedAreasWithGaussAsJPG(int data_layer, int marker_layer);
